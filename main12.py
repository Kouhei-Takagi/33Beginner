...
param_grid = {
    ...
    'rf__criterion': ['gini'],
    'rf__min_impurity_decrease': [0.0, 0.05],
    'gb__learning_rate': [0.01, 0.1],
    'gb__max_iter': [100, 200],
    'gb__max_depth': [10, 15],
    'gb__max_leaf_nodes': [None, 4],
    'gb__min_samples_leaf': [1, 2, 4],
    'gb__l2_regularization': [0.0, 0.2]
}
...
# 学習済みモデルを保存する
joblib.dump(grid_search.best_estimator_, 'best_model8.pkl')
...
# 学習済みモデルを読み込む
model = joblib.load('best_model8.pkl')
